...
ResQ brings a Quantum twist to the classic point-and-click adventure story game. It introduces quantum concepts like entanglement and superposition in an engaging and fun way, making them easier to understand. The game follows the journey of **Professor Unknown**, who has lost their memory and is relearning quantum concepts alongside the player.

### Key Features:
- **Story-based gameplay**: Solve puzzles with Professor Unknown.
- **Quantum learning**: Familiarize yourself with quantum ideas like entanglement and superposition.
...
Embark on an exciting journey with **Charlie and the Quantum Factory** by Fraunhofer AISEC! As Charlie, a curious researcher, explore a vibrant virtual lab filled with quantum mysteries.

### Gameplay Highlights:
- **Movement**: Explore using traditional platformer controls (W, A, S, D or arrow keys).
- **Puzzle-solving**: Tackle mini-games to grasp quantum concepts like qubits, superposition, and entanglement.
...
### How It Works:
- **Superposition**: Mark two squares at once, reflecting the quantum idea of being in two states at once.
...
### Gameplay Overview:
- Take turns marking squares and watch how your marks interact.
...
This game is available on the Google Play Store and is a fun way to experience quantum mechanics in a familiar format.
...
## QCards: Learn Quantum Computing Through Play
...
- **Cards**: 
  - **Qubit Cards**: Represent quantum states like |0⟩ and |1⟩.
...
- Play solo, in teams, or collaboratively.

QCards is a great way to interactively learn quantum concepts, suitable for all skill levels.

## Quantum Flytrap: An Intuitive Platform for Quantum Learning
...
- **Build Quantum Circuits**: Add gates like Hadamard or CNOT and see real-time effects.
...
### Key Features:
- **Photon Navigation**: Direct a photon through a series of quantum devices.
...
The game offers a hands-on approach to learning quantum physics, perfect for students and curious minds.
...
## Quantum Moves 2: Solve Quantum Challenges
...
## The Qubit Game by Google Quantum AI
