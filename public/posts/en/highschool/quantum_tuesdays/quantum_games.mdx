...
- **Quantum learning**: Familiarize yourself with quantum ideas like [entanglement](https://wiqi.info/en/posts/entries/higschool/entanglement) and [superposition](https://wiqi.info/en/posts/entries/highschool/superposition).
