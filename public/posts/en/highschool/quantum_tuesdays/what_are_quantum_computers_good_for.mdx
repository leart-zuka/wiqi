...
NP-problems are defined by the fact that they are very hard to solve, but if we were to find a solution, we can easily and quickly verify if the solution we got is `efficient` or not.
