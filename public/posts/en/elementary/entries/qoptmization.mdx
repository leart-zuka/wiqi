...
subtitle: "Quantum Optimization: Solving the Hardest Problems with the Weirdest Tools(easy)"
...
This is infact a physical process inspired by nature. Imagine a landscape of hills and valleys where the lowest valley is the best solution. In classical annealing, you'd let a particle bounce around this landscape and hope it settles in the deepest valley. But the particle could accidentally land in a shallow valley without any knowledge of other deeper valleys. In **quantum annealing** however, the particle can also [_tunnel_](/en/posts/entries/elementary/qtunnelling) through hills instead of climbing over them, allowing it to escape local traps more easily. Through Quantum Annealing you can reach the true lowest point (global minimum) without going through the entire landscape.
