...
Werner Heisenberg said that in quantum physics, we can't measure everything perfectly. For example, we can’t know both the exact position and speed of an electron at the same time. The more accurately we try to measure one property, the more inaccurate the other one becomes.
