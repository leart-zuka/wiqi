...
To use quantum computers for science, we need to describe the energy of a molecule with something called a Hamiltonian. But quantum computers don’t understand electrons the way humans do — we have to translate their behavior using different transformation. Through these transformations, we can make a qubit behave exactly like on of the electrons. It's a bit like teaching the computer a new language.
