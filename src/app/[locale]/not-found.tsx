...
export default function NotFound() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 px-4 text-center">
      ...
      <div className="animate-pulse-slow absolute inset-0 bg-gradient-to-tl from-cyan-500/10 via-transparent to-violet-500/10"></div>
      ...
      {QUANTUM_EQUATIONS.map((equation, i) => (
        <div
          key={i}
          className="animate-float-equation absolute font-mono text-xs text-blue-300/30"
          style={{
            left: `${15 + i * 15}%`,
            top: `${20 + i * 10}%`,
      ...
      <div className="animate-spin-slow absolute left-1/4 top-1/4 h-32 w-32 rounded-full border border-blue-400/30">
        <div className="animate-spin-slow-reverse absolute inset-4 rounded-full border border-cyan-400/20"></div>
      </div>
      <div className="animate-spin-slow-reverse absolute bottom-1/4 right-1/4 h-24 w-24 rounded-full border border-purple-400/30">
        <div className="animate-spin-slow absolute inset-2 rounded-full border border-pink-400/20"></div>
      </div>
      <div className="animate-bounce-slow absolute bottom-1/3 left-1/3 h-16 w-16 rounded-full border border-pink-400/30"></div>
      <div className="animate-pulse-slow absolute right-1/3 top-1/3 h-20 w-20 rounded-full border border-emerald-400/30"></div>
      ...
      <div className="animate-pulse-slow absolute left-1/2 top-1/2 h-64 w-64 -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-r from-pink-500/15 via-purple-500/10 to-blue-500/15 blur-2xl"></div>
      ...
      <div
        ...
        style={{
          left: smoothMousePos.current.x,
          top: smoothMousePos.current.y,
