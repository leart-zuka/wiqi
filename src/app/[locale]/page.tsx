        ...
        <main>
            <nav className="bg-opacity-20 bg-white w-full start-0 h-fit">
                <div className="flex flex-wrap items-center mx-auto justify-between p-2">
                    <a href="https://www.pushquantum.tech/" className="flex items-center space-x-0">
                        <img src="pq_logo.svg" className="h-8 p-2" alt="PushQuantum Logo" />
                        <span className="text-lg font-semibold italic dark:text-white"> PushQuantum</span>
                    </a>
                    <DropDown className={"relative right-12 w-20"} stateChange={setDifficulty} />
