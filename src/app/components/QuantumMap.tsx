                ...
                {nodes.map((node, index) => (
                    ...
                    >
                        <Link href={node.url} className="block">
                            <div
                                className={`flex cursor-pointer items-center justify-center rounded-full border-2 backdrop-blur-sm transition-transform duration-300 group-hover:scale-110 ${node.id === "center"
