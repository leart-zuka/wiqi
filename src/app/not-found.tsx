...
export default function NotFound() {
  ...
  useEffect(() => {
    ...
    // Fetch random post suggestion
    // NOTE: This API might suggest posts that don't exist in the file system
    // due to differences between the API's file scanning and the actual routing logic.
    // If a user clicks on a suggested post and gets a 404, they'll see this page again.
