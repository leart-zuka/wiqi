    ...
    <Card className="mt-4 h-full p-4">
      ...
      <div className="grid grid-cols-3 gap-2">
        <Button
          ...
          className="h-10 w-10 hover:border-blue-300 hover:bg-blue-50 dark:hover:border-blue-600 dark:hover:bg-blue-950/20"
          title="Share on X"
        >
        ...
        <Button
          ...
          className="h-10 w-10 hover:border-orange-300 hover:bg-orange-50 dark:hover:border-orange-600 dark:hover:bg-orange-950/20"
        ...
        <Button
          ...
          className="h-10 w-10 hover:border-green-300 hover:bg-green-50 dark:hover:border-green-600 dark:hover:bg-green-950/20"
        ...
        <Button
          ...
          size="icon"
          onClick={copyUrl}
          className="h-10 w-10 hover:border-slate-300 hover:bg-slate-50 dark:hover:border-slate-600 dark:hover:bg-slate-950/20"
